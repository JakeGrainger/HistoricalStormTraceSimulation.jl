...
"""
function score_method(history::StormHistory; samplemethod=1:50, rescalemethod, summarymetric::Metric=Euclidean(), tracescore::TraceScore, trace_repeats::Int=1,interpolation_method=LinearInterpolation)
    ...
    for i in 1:length(history)
        ...
        for j in 1:trace_repeats
            newtrace = samplesingletrace(history.summaries[i],temporary_history,sampler,rescalemethod,interpolation_method)
